        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetNumber = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuelType = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    NumOfDoors = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChildSeat = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservation_Location_EndLocationId",
                        column: x => x.EndLocationId,
                        principalTable: "Location",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reservation_Location_StartLocationId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "415a7c65-81dd-4fe3-9c44-9493db860c4b", null, "Admin", "ADMIN" },
                    { "8a000e3b-b915-43f1-b90e-b28075ec8cac", null, "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservation_EndLocationId",
                table: "Reservation",
                column: "EndLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservation_StartLocationId",
                table: "Reservation",
